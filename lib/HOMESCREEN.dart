        ...
        SafeArea(
          child: Stack(
            children: <Widget>[
              ...
              //           end: Alignment(1.0, -0.028),
              //           colors: [
              //             const Color(0xffaf7bfb),
              //             const Color(0xffe27aff)
              //           ],
              //           stops: [0.0, 1.0],
              //         ),
              //       ),
              ...
              //                       child: Padding(
              //                         padding:
              //                             EdgeInsets.fromLTRB(0.5, 0.5, -0.5, 0.5),
              ...
              //       ),
              //       Pinned.fromPins(
              //         Pin(size: 15.1, end: 44.0),
              //         Pin(size: 11.1, middle: 0.5151),
              //         child: Stack(
              //           children: <Widget>[
              //             Stack(
              //               children: <Widget>[
              ...
              //       ),
              //       Align(
              //         alignment: Alignment(0.642, 0.059),
              //         child: SizedBox(
              //           width: 17.0,
              //           height: 10.0,
              //           child: Stack(
              ...
              // Positioned(
              //   child: Align(
              //     alignment: Alignment(-0.344, 0.421),
              //     child: Container(
              //       width: 52.0,
              //       height: 14.0,
              //       color: const Color(0xfff2f4f7),
              ...
              // Pinned.fromPins(
              //   Pin(size: 22.0, middle: 0.7167),
              //   Pin(size: 9.0, end: 119.0),
              //   child: Container(
              //     color: const Color(0xff124a27),
              //   ),
              // ),
            ],
          ),
